...
const BENEFITS = [
  ...
  'После оплаты доступ открывается на выбранный срок',
];
        ...
        if (disposed || !response.ok || !data.order) {
          setCheckoutNotice(
            paymentState === 'cancelled'
              ...
              : 'Платёж отправлен в обработку. Как только оплата подтвердится, доступ по подписке откроется в кабинете.'
          );
          return;
        }
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-blue-800">
                  ...
                  Если оплатить новый тариф сейчас, срок будет продлён на выбранный оплаченный период.
                </p>
              </div>
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                      После оплаты доступ откроется на {plan.months}{' '}
          ...
          <aside className="h-fit rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-5 border-t border-gray-100 pt-5">
              ...
              <div className="mt-4 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs leading-relaxed text-amber-900">
                ...
                Когда рекуррентные платежи будут одобрены и включены, перед оплатой появится отдельное согласие на автопродление.
              </div>
              ...
              <p className="mt-3 text-xs leading-relaxed text-gray-500">
                Сумма и срок доступа подтверждаются на сервере. После оплаты статус обновится в кабинете.
              </p>
            </div>
          </aside>
        </div>
